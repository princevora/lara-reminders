<div>
    <flux:navlist variant="outline">
        <flux:navlist.group :heading="__('Notifications')" class="grid relative">
            <flux:navlist.item icon="bell-alert" :href="url()->to('/')" wire:navigate class="relative flex items-center">
                ...
                {{ __('Notifications') }}
                <flux:badge color="lime" class="mx-10" size="sm">{{ $unreadNotifications }}</flux:badge>
            </flux:navlist.item>
        </flux:navlist.group>
    </flux:navlist>
</div>
